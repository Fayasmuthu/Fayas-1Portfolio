...
})(jQuery); /*!bootstrap-progressbar v0.9.0 | Copyright (c) 2012-2015 Stephan Groß | MIT license | http://www.minddust.com*/
! function(t) {
    "use strict";
    var e = function(n, s) {
...
! function(t) {
    ...
    function a() {
        t(".js-slick-test").each(function() {
            var a = t(this).find(".client-avatar img").offset().top - t(this).offset().top;
            t(this).find(".arrow").css("top", a)
        })
    }
    var i = t("html, body"),
        e = t(".js-slick");
    e.each(function() {
        function a(a) {
            a.each(function() {
                ...
                }), a.addClass(e).one("webkitAnimationEnd mozAnimationEnd MSAnimationEnd oanimationend animationend", function() {
                    a.removeClass(e)
                })
            })
        }
        ...
        for (var e in i) i.hasOwnProperty(e) && null != t(this).attr("data-slick-" + e) && (i[e] = t(this).data("slick-" + e));
        i.thumb ? t(this).slick({
            ...
            customPaging: function(a, i) {
                return '<img src=" ' + t(a.$slides[i]).data("thumb") + ' "/><div class="bg-overlay"></div>'
            },
            responsive: [{
                breakpoint: 1600,
                settings: {
            ...
            a(t(this).find('[data-slick-index="' + o + '"]').find("[data-animation]"))
        })
    ...
    var o = !1,
        s = t(".js-waypoint");
    s && s.waypoint(function() {
        o || (o = !0, t(".au-progress .au-progress-bar").progressbar({
            update: function(t, a) {
                a.find(".value").html(t + "%")
            }
        }))
    ...
    p.on("click", function(a) {
        var e = t(this);
        r.hasClass("sticky") ? i.animate({
            scrollTop: t(e.attr("href")).offset().top - r.outerHeight()
        }, 800) : r.addClass("sticky").delay(300).queue(function(a) {
            a(), i.animate({
                scrollTop: t(e.attr("href")).offset().top - r.outerHeight()
            }, 800)
        }), l.slideUp(), a.preventDefault()
        ...
        p.parent().removeClass("active").end().filter("[href='#" + e + "']").parent().addClass("active")
    }), l.hide(), c.on("click", function(t) {
    ...
    f.on("show.bs.modal", function() {
        t(this).find(".modal-dialog").attr("class", "modal-dialog  fadeIn  animated"), t(this).find(".modal-primary").hide()
    }), f.on("shown.bs.modal", function() {
        var a = t(this).find(".loader");
        a.show(), t(this).find(".modal-primary").delay(1e3).fadeIn(500, function() {
            e.slick("setPosition"), a.hide()
        })
    }), f.on("hide.bs.modal", function() {
        t(this).find(".modal-dialog").attr("class", "modal-dialog  fadeOut  animated")
    ...
    t.fn.introSlider = function(a) {
        return a = t.extend({
            ...
            if ("fullscreen" == a.layout) {
                ...
                n.height(o), t(window).width() >= 992 && t(window).on("resize", function() {
                    o = t(window).height(), n.height(o)
                })
            }
            null != a.bg && (n.css("background", "url(" + a.bg + ") center center no-repeat"), n.css("background-size", "cover")), window.onload = function() {
                n.find("[data-intro-animate]").css("visibility", "hidden"), n.find("[data-intro-animate]").each(function() {
                    var a = t(this).data("intro-animate"),
                        i = t(this).data("intro-delay");
                    t(this).delay(i).queue(function(i) {
                        t(this).addClass(a), t(this).css("visibility", "visible"), i()
                    })
                })
            }
        }), this
        ...
        for (var i in a) a.hasOwnProperty(i) && null != t(this).attr("data-intro-" + i) && (a[i] = t(this).data("intro-" + i));
        t(this).introSlider({
            layout: a.layout,
            bg: a.bg
        })
    ...
    var v = t("#up-to-top");
    v.hide(), t(window).on("scroll", function() {
